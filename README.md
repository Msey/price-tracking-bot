...
Локальный бот для Windows: следит за ценами на **DNS**, **Ozon**, **Яндекс.Маркете** и **Wildberries**, рисует график в окне на компьютере и пишет в Telegram, когда цена изменилась.
...
| Действие | Как |
| --- | --- |
| Добавить товар | Прислать ссылку на карточку DNS, Ozon, Яндекс.Маркета или Wildberries. Короткие ozon.ru/t/… тоже принимаются. |
