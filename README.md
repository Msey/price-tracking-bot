...
На снимке три карточки. Телевизор без изменения — бронзовая горизонталь. Ковёр подешевел — зелёная кривая. Саморезы подорожали — красная.

## Что делает бот

- Принимает ссылку на карточку товара в личке Telegram.
- Открывает страницу в отдельном профиле Chrome через своё расширение и читает цену, как её видит человек.
