...
Разовый порог — отдельное письмо «цена ниже порога». Оно уходит только тому, кто задал число, и только один раз. Пока цена не найдена или товар пропал с витрины, порог не срабатывает. Равенство порогу не считается: нужна цена строго ниже.
