...
func TestParseDisplayedPrice(t *testing.T) {
	...
	// "5 672 5 105" — тот же случай без ₽ между ценами: разряды не по три,
	// значит это две цены, а не 56 725 105 ₽.
	bad := []string{
		"1 999 ₽ 2 999 ₽", "116 900 38 583", "нет в наличии", "", "0 ₽",
		"2 000 000 000 ₽", "5 672 5 105 ₽", "5 105 5 672", "12 34 567 ₽",
	}
	for _, in := range bad {
